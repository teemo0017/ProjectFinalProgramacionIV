    ...
    <nav class="barra-navegacion">
        ...
        <ul class="barra-opciones">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href=""><?php echo $servicio['nombre'] ?></a>
